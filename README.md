...
| Sheet | Description |
|-------|-------------|
| **Original Data** | Raw retail sales dataset as received, unmodified |
| **Cleaned Data** | Processed data after handling nulls, duplicates, and formatting |
| **Dataset Understanding** | Column definitions, data types, and dataset overview |
| **Data Quality Check** | Identified and documented data issues (missing values, outliers, etc.) |
| **Basic Analysis** | Summary statistics, totals, averages, and key metrics |
| **Sorting and Filtering Screenshots** | Visual documentation of sorting/filtering operations applied |
...
### Dashboard 2
![Dashboard 2](Total Quantity Sold by Product Category.png)

### Dashboard 3
![Dashboard 3](Total Sales by Gender.png)
